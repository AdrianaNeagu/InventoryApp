...
import com.example.adriana.inventoryapp.data.InventoryContract;
import com.example.adriana.inventoryapp.data.InventoryDbHelper;
...
public class CatalogActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void insertProduct() {
        ...
        values.put(InventoryContract.ProductEntry.COLUMN_PRODUCT_NAME, "Sugar");
        values.put(InventoryContract.ProductEntry.COLUMN_PRODUCT_PRICE, 10);
        values.put(InventoryContract.ProductEntry.COLUMN_PRODUCT_QUANTITY, 20);
        values.put(InventoryContract.ProductEntry.COLUMN_PRODUCT_SUPPLIER_NAME, "Pepco");
        values.put(InventoryContract.ProductEntry.COLUMN_PRODUCT_SUPPLIER_PHONE, "65535");
